            ...
            <View styles={{ height: '100%' }}>
                <View style={styles.BlueBox}>
                    <TouchableOpacity activeOpacity={0.5} style={styles.arrow}>
                        <FontAwesome style={styles.FontAwesomeArrow} name={'angle-left'} size={35} color={Color.Main} />
                    </TouchableOpacity>
                ...
                <View style={styles.MainContainer}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <CustomButton containerStyle={{ marginTop: scale(50) }} title={'Confirm'} textStyle={{ fontSize: scale(27) }} />
